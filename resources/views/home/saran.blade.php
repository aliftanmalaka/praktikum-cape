        ...
        <div class="card">
            <div class="card-body flex flex-col p-6">
                ...
                <div class="card-text h-full ">
                    ...
                    <form class="space-y-4" method="POST" action="{{ route('home.saran.store') }}">
                        @csrf
                        <div class="input-area relative">
                            <label for="saran_nama" class="form-label">{{ __('saran.field.saran_nama') }}
                                <x-required /></label>
                            <input type="text" id="saran_nama" name="saran_nama" class="form-control"
                                placeholder="{{ __('table.enter') }} {{ __('saran.field.saran_nama') }}"
                                value="{{ old('saran_nama') }}">
