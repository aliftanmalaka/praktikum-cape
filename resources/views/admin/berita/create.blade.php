    ...
    <div class="card">
        <div class="card-body flex flex-col p-6">
            ...
            <div class="card-text h-full ">
                ...
                <form class="space-y-4" method="POST" action="{{ route('admin.berita.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="input-area relative">
                        ...
                        <textarea id="berita_desc" name="berita_desc" rows="5" class="form-control my-editor"
                            placeholder="{{ __('table.enter') }} {{ __('berita.field.berita_desc') }}">{!! old('berita_desc') !!}</textarea>
                        <x-input-error :messages="$errors->get('berita_desc')" class="mt-2" />
                    </div>
                    <div class="input-area">
                        <label for="berita_foto" class="form-label">{{ __('berita.field.berita_foto') }}
                            <x-required /></label>
