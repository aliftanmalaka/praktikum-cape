                                ...
                                <table
                                    ...
                                    <thead class=" bg-slate-200 dark:bg-slate-700">
                                        <tr>
                                            ...
                                            <th scope="col" class=" table-th ">
                                                {{ __('berita.field.berita_foto') }}
                                            </th>
                                            <th scope="col" class=" table-th ">
                                                {{ __('berita.field.berita_judul') }}
                                            </th>
                                            <th scope="col" class=" table-th ">
                                                {{ __('berita.field.user_id') }}
                                            </th>
                                            <th scope="col" class=" table-th ">
                                                {{ __('berita.field.berita_desc') }}
                                            </th>
                                            <th scope="col" class=" table-th ">
                                                {{ __('table.action') }}
                                            </th>
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($beritas as $key => $berita)
                                            <tr>
                                                ...
                                                <td class="table-td">
                                                    <img src="{{ Storage::url($berita->berita_foto) }}"
                                                        class="rounded-md border-4 max-w-full w-full block"
                                                        alt="{{ $berita->berita_judul }}">
                                                </td>
                                                <td class="table-td">{{ $berita->berita_judul }}</td>
                                                <td class="table-td">{{ $berita->user ? $berita->user->name : 'Null' }}</td>
                                                <td class="table-td">{!! Str::limit($berita->berita_desc, 110, ' ...') !!}</td>
                                                <td class="table-td ">
