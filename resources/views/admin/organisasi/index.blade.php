                                ...
                                <table
                                    ...
                                    <thead class=" bg-slate-200 dark:bg-slate-700">
                                        <tr>
                                            ...
                                            <th scope="col" class=" table-th ">
                                                {{ __('organisasi.field.organisasi_nama') }}
                                            </th>
                                            <th scope="col" class=" table-th ">
                                                {{ __('table.action') }}
                                            </th>
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($organisasies as $key => $organisasi)
                                            <tr>
                                                <td class="table-td">{{ $key + 1 }}</td>
                                                <td class="table-td">{{ $organisasi->organisasi_nama }}</td>
                                                <td class="table-td ">
                                                    <div class="flex space-x-3 rtl:space-x-reverse">
                                                        <a href="{{ route('admin.organisasi.show', $organisasi->id) }}"
                                                        ...
                                                        <form
                                                            action="{{ route('admin.organisasi.destroy', $organisasi->id) }}"
                                                            method="POST">
                                                            @method('DELETE')
                                                            @csrf
