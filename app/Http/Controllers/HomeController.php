...
class HomeController extends Controller
{
    ...
    public function berita() {
        $title = __('home.title.berita');
        $beritas = Berita::orderBy('created_at', 'ASC')->paginate(8);
        return view('home.berita', compact('title', 'beritas'));
    }

    public function berita_show(Berita $berita) {
        $title = __('home.title.berita-show');
        return view('home.berita-show', compact('title', 'berita'));
    }
